...
<body>
        ...
        <div class="container">
            ...
            <div class="nav-menu">
                ...
                @guest
                    ...
                    <a href="{{ route('login') }}" class="primary-btn signup-btn">
                        Iniciar Sesión</a>
                @else
                    <a href="{{ route('home') }}" class="primary-btn signup-btn">
                        Dashboard</a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-pic">
                        <img src="{{ asset('web/img/services/service-pic.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="services-item">
                                    <img src="{{ asset('web/img/services/service-icon-2.png') }}" alt="">
                                    <h4>Yoga</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
                                <div class="services-item pd-b">
                                    <img src="{{ asset('web/img/services/service-icon-4.png') }}" alt="">
                                    <h4>Weight Loss</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
    ...
    <section class="classes-section spad">
        <div class="container">
            ...
            <div class="row classes-slider owl-carousel">
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-1.jpg') }}">
                        <div class="si-text">
                            <h4>Yoga</h4>
                            <span><i class="fa fa-user"></i> Ryan Knight</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-4.jpg') }}">
                        <div class="si-text">
                            <h4>Karate</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-2.jpg') }}">
                        <div class="si-text">
                            <h4>Running</h4>
                            <span><i class="fa fa-user"></i> Randy Rivera</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-5.jpg') }}">
                        <div class="si-text">
                            <h4>Dance</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-3.jpg') }}">
                        <div class="si-text">
                            <h4>Personal Training</h4>
                            <span><i class="fa fa-user"></i> Cole Robertson</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-6.jpg') }}">
                        <div class="si-text">
                            <h4>Weight Loss</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-7.jpg') }}">
                        <div class="si-text">
                            <h4>Personal Training</h4>
                            <span><i class="fa fa-user"></i> Cole Robertson</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="{{ asset('web/img/classes/classes-8.jpg') }}">
                        <div class="si-text">
                            <h4>Weight Loss</h4>
                            <span><i class="fa fa-user"></i> Ryan Scott</span>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="{{ asset('web/img/trainer/trainer-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="{{ asset('web/img/trainer/trainer-2.jpg') }}" alt="">
                        <div class="trainer-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="{{ asset('web/img/trainer/trainer-3.jpg') }}" alt="">
                        <div class="trainer-text">
                            <h5>Walter Wagner</h5>
                    ...
                    <div class="testimonial-slider owl-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="ti-pic">
                                ...
                                <div class="quote">
                                    <img src="{{ asset('web/img/testimonial/quote-left.png') }}" alt="">
                                </div>
                            </div>
                            <div class="ti-author">
    ...
    <section class="banner-section set-bg" data-setbg="{{ asset('web/img/banner-bg.jpg') }}">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <img src="{{ asset('web/img/banner-person.png') }}" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="register-pic">
                        <img src="{{ asset('web/img/register-pic.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-item">
                        <img src="{{ asset('web/img/blog/blog-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-item">
                        <img src="{{ asset('web/img/blog/blog-2.jpg') }}" alt="">
                        <div class="blog-widget">
                            <div class="bw-date">February 17, 2019</div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-item">
                        <img src="{{ asset('web/img/blog/blog-3.jpg') }}" alt="">
                        <div class="blog-widget">
                            <div class="bw-date">February 17, 2019</div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="footer-banner-item set-bg"
                        data-setbg="{{ asset('web/img/footer-banner/footer-banner-1.jpg') }}">
                ...
                <div class="col-lg-6">
                    <div class="footer-banner-item set-bg"
                        data-setbg="{{ asset('web/img/footer-banner/footer-banner-2.jpg') }}">
    ...
    <footer class="footer-section">
        <div class="container">
            ...
            <div class="subscribe-option set-bg" data-setbg="{{ asset('web/img/footer-signup.jpg') }}">
                <div class="so-text">
